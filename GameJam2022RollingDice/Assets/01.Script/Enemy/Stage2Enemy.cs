...
public class Stage2Enemy : Enemy
{
    ...
    public override void Attack()
    {
        ...
        {
            case 0:
                UIManager.Instance.nextSkillTitle.text = "Shield Break Attack";
                UIManager.Instance.nextSkillExplain.text = "(Deals 18 damage when the guard gauge is present, and 10 damage when it doesn't.) X Dice Eyes";
                Debug.Log("ù��° ��ų ���");
                StartCoroutine(Skill0AttackCor());
                break;

            case 1:
                UIManager.Instance.nextSkillTitle.text = "Heart Break Attack";
                UIManager.Instance.nextSkillExplain.text = "(Deals 18 damage when the guard gauge is not present, and 10 damage when it does.) X Dice Eyes";
                Debug.Log("�ι�° ��ų ���");
